...
def move_stack(n, start, end):
    ...
    "*** YOUR CODE HERE ***"
    # 递推公式 -> H(n) = H(n - 1) + 1 + H(n - 1): 将n-1从s到m，1从s到e，n-1从m到e
    if n == 1:
...
def make_anonymous_factorial():
    ...
    def func(x, func):
        if x == 1:
            ...
            return x * func(x-1, func)
    or
    lambda n : (lambda x, func : 1 if x ==1 else x * func(x - 1, func))(
        n, lambda x, func : 1 if x ==1 else x * func(x - 1, func))
